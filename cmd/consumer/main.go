...
func main() {
	...
	kafka_client.RegisterConsumer(kafka_client.KAFKA_TOPIC_SUMMARY_REQUEST, consumers.StartSummaryConsumer)
	kafka_client.RegisterConsumer(kafka_client.KAFKA_TOPIC_SENTIMENT_REQUEST, consumers.StartSentimentAnalysisConsumer)
